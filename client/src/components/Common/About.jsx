...
import abt37 from "../../assets/images/abt37.jpg"
          ...
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <div className="about-addax">
                <div className="section-title">
                  <h2>
                    We Are TechPoT <span>Media & It Services</span>
                  </h2>
                  <p>We offer the services in Web development , Mobile development , Healthcare services , Customer Software development ,Progressive Webapps development , AI, Ar & VR technologies, Digital Media Managment </p>
                </div>
